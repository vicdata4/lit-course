  ...
  render() {
    if (this.resultados !== '') {
      if (this.category === 'mtg') {
        return html` <api-mtg .hits="${this.resultados}" .cardStyle="${this.cardStyle}"></api-mtg> `;
      } else if (this.category === 'pok') {
        return html` <api-pok .hits="${this.resultados}"></api-pok> `;
      } else if (this.category === 'mov') {
        return html` <api-omd .hits="${this.resultados}"></api-omd> `;
      }
    } else {
      nothing;
    }
