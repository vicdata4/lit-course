...
class StatBar extends LitElement {
    ...
    render() {
        return html`
            <div>
                <div class="barraTotal" style="width: ${this.widthBar}px; height: ${this.heightBar}px;" id="widthBar">&nbsp;</div>
                <div class="barraLlena" style="width: ${this.filled}px; height: ${this.heightBar}px; background: ${this.colorCalc()};" id="filled">&nbsp;</div>
            </div>
        `;
    }
}
