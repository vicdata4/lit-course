                ...
                <div class="cardPok">
                    ...
                    <div class="card-footer">
                        <div style="display: flex; justify-content: center;">
                            <div>
                                <img style="display:block; margin: 0 auto;" src="assets/images/Typespok/XYROZA/${this.hits.types[0].type.name}.png">
                            </div>
                            ${this.hits.types[1] ? html`
                                <div style="margin-left: 10px;">
                                    <img style="display:block; margin: 0 auto;" src="assets/images/Typespok/XYROZA/${this.hits.types[1].type.name}.png">
                                </div>
                            ` : nothing }
                        </div>
                    </div>
